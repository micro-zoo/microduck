...
cargo run -p xtask -- package \
    ...
    --include "policies/wbc_curious.csv=policies/wbc_curious.csv" \
    --include "policies/wbc_happy_bob.csv=policies/wbc_happy_bob.csv" \
    --include "policies/wbc_wiggle.csv=policies/wbc_wiggle.csv" \
